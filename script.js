...
// At the very end of your script.js file
    ...
    async function checkWorkstationStatus() {
      const statusDot = document.getElementById('workstation-status-dot');
      const statusText = document.getElementById('workstation-status-text');
      ...
      try {
        ...
        const data = await response.json(); // Data will have { status: 'online' | 'offline', message: string }
